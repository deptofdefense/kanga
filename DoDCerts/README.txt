...
On Mac OSX:
$ openssl smime -verify -in Certificates_PKCS7_v5.9_DoD.sha256 -inform DER -CAfile DoD_PKE_PEM.pem | shasum -a 256 -c
...
On Linux:
$ openssl smime -verify -in Certificates_PKCS7_v5.9_DoD.sha256 -inform DER -CAfile DoD_PKE_PEM.pem | dos2unix | sha256sum -c
...
Verify that the output matches the hash listed for the file in the Certificates_PKCS7_v5.9_DoD.sha256 openssl smime -verify output.
